...
" Mod:     http://www.vim.org/scripts/script.php?script_id=3742
" 
...
sy region wikiTemplate matchgroup=wikiTemplateTag start="{{" matchgroup=wikiTemplateTagEnd end="}}"
	\ keepend extend contains=wikiNowiki,wikiNowikiEndTag,wikiTemplate,wikiVar,@htmlTop
sy region wikiTemplate matchgroup=wikiTemplateTag start=+{{\s*#+ matchgroup=wikiTemplateTagEnd end="}}"
	\ keepend extend contains=wikiNowiki,wikiNowikiEndTag,wikiTemplate,wikiVar,@htmlTop
sy region wikiVar matchgroup=wikiVarTag start="{{{" matchgroup=wikiVarTagEnd end="}}}"
	\ keepend extend contains=wikiTemplate
...
HtmlHiLink wikiVar		htmlConstant
HtmlHiLink wikiVarTag		htmlTagName
HtmlHiLink wikiVarTagEnd	htmlTagName
HtmlHiLink wikiTemplateTag	htmlTag
HtmlHiLink wikiTemplateTagEnd	htmlTag
