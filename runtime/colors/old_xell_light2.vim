...
" Vim color file
" Maintainer: Xell Liu
" Last Change: 2012.122
" thanks to: http://yue.fm/
" 主背景（浅） #f6f7f8 rgb(246, 247, 248)
" 主背景（深） #f1f3f5 rgb(241, 243, 245)
" 文字（深）   #333c44 rgb(51, 60, 68)
" 文字（浅）   #979b9f rgb(151, 155, 159)
" 中灰色1      #98a0a9 rgb(152, 160, 169)
" 中灰色2      #646d76 rgb(100, 109, 118)
" 浅灰色       #e6e6e6 rgb(230, 230, 230)
...
"  highlight Normal        guifg=#3F2A18     guibg=#F5EFDC     ctermfg=15 ctermbg=8
 highlight Normal        guifg=#3F2A18     guibg=#C5E7CE     ctermfg=15 ctermbg=8
