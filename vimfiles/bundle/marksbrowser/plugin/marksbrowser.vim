...
" g:marksCloseWhenSelected in your ~/.vimrc file
" 	Example: let g:marksCloseWhenSelected = 0
"
" Installation:
...
if !exists("g:marksCloseWhenSelected")
  let s:marksCloseWhenSelected = 1
else
  let s:marksCloseWhenSelected = g:marksCloseWhenSelected
endif

let s:win_title = '[Marks]'
if !exists("g:marksShowTypes")
	let s:all_marks = "abcdefghijklmnopqrstuvwxyz.'`^<>\""
else
	let s:all_marks = g:marksShowTypes
endif
